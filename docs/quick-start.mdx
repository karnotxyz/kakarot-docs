...
#### 添加 Kakarot Sepolia到 Metamask

您可以点击下面的按钮，将 Kakarot Sepolia 添加到 Metamask：
...
或在 Metamask 中手动添加新网络：打开 Metamask 扩展。单击
"Add Network". 选择 "Add a Network Manually"。然后填写字段：
...
| Chain Id       | 1802203764                      |
| Symbol         | ETH                             |
| Block Explorer | ⚠️ Coming Soon ⚠️               |
